...
if __name__ == "__main__":
	...
	parser.add_argument("--keepGS", action='store_true', help="Keep DR")
	...
	csub_command = "csub run.sh -t tomorrow --os SLCern6 -F {} --queue_n {}".format(",".join(files_to_transfer), args.njobs)
